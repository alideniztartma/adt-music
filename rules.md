...
If you copy, adapt, or reuse any part of the source code from the **ADT Music** project in your own application or repository, you must adhere to the following rules under the GPL-3.0 license:
...
Since ADT Music is licensed under the GPL-3.0 license, any project copying, modifying, or using this code **must also be fully open-sourced** under the GPL-3.0 license. You cannot copy this code into a closed-source or proprietary application.
