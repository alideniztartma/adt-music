...
import com.music.adt.eq.data.FilterType
import com.music.adt.eq.data.ParametricEQBand
...
class AxionEqViewModel @Inject constructor(
    ...
    private val prefs = context.getSharedPreferences("adt_eq_prefs", Context.MODE_PRIVATE)
    ...
    val customProfiles = eqProfileRepository.profiles.map { profiles ->
        profiles.filter { it.isCustom && it.id != "adt_tuning" }
