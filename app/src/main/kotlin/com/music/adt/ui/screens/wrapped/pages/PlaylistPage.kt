package com.music.adt.ui.screens.wrapped.pages
...
import com.music.adt.ui.screens.wrapped.LocalWrappedManager
import com.music.adt.ui.screens.wrapped.PlaylistCreationState
import com.music.adt.ui.screens.wrapped.WrappedConstants
import com.music.adt.ui.screens.wrapped.components.AnimatedBackground
import com.music.adt.ui.screens.wrapped.components.AutoResizingText
import com.music.adt.ui.screens.wrapped.components.ShapeType
import com.music.adt.ui.theme.bbh_bartle
...
fun PlaylistPage() {
    ...
    val (playlistImageRes, playlistImageName) = remember {
        if (Random.nextBoolean()) {
            Pair(R.drawable.adtwrapped_v1, "adtwrapped_v1")
        } else {
            Pair(R.drawable.adtwrapped_v2, "adtwrapped_v2")
        }
    }
