...
import com.music.adt.constants.CipherLastUpdatedKey
import com.music.adt.constants.CipherManualUpdate1Key
import com.music.adt.constants.CipherManualUpdate2Key
import com.music.adt.constants.CipherManualUpdate3Key
...
import com.music.adt.utils.cipher.PlayerConfigStore
...
fun CipherSettings(
    ...
    Column(
        ...
        Card(
            onClick = {
                Toast.makeText(context, "ADT-Extractor is required for playback and cannot be disabled.", Toast.LENGTH_SHORT).show()
            },
