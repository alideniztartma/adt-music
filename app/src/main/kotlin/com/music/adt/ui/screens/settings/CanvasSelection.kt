...
import com.music.adt.ui.component.AnimatedRadioButton
...
import com.music.adt.ui.component.ModernSwitch
...
fun CanvasSelection(
    ...
    Column(
        ...
        // Description text
        Text(
            text = stringResource(R.string.adtmusic_canvas_desc),
        ...
        Material3SettingsGroup(
            ...
            items = listOf(
                ...
                Material3SettingsItem(
                    leadingContent = {
                        AnimatedRadioButton(
                            selected = canvasSource == CanvasSource.ADTMUSIC,
                            onClick = null,
                            enabled = canvasThumbnailAnimation
                        )
                    },
                    title = { Text(stringResource(R.string.canvas_source_adtmusic)) },
                    description = { Text(stringResource(R.string.canvas_source_adtmusic_desc)) },
                    enabled = canvasThumbnailAnimation,
                    onClick = { onCanvasSourceChange(CanvasSource.ADTMUSIC) },
                    isExpressive = true,
                    descriptionBelow = true
                ),
                Material3SettingsItem(
