...
package com.music.adt.listentogether
...
import com.music.adt.constants.ListenTogetherAutoApprovalKey
import com.music.adt.constants.ListenTogetherIsHostKey
import com.music.adt.constants.ListenTogetherRoomCodeKey
import com.music.adt.constants.ListenTogetherServerUrlKey
import com.music.adt.constants.ListenTogetherSessionTimestampKey
import com.music.adt.constants.ListenTogetherSessionTokenKey
import com.music.adt.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.music.adt.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.music.adt.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.music.adt.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.music.adt.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(com.music.adt.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.music.adt.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
    ...
    private fun getServerUrl(): String {
        ...
        // If the saved URL is no longer in our list (e.g. Meowery was removed), revert to ADTMusic default
