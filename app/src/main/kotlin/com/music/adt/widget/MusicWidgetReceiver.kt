...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.music.adt.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "com.music.adt.widget.LIKE"
        const val ACTION_NEXT = "com.music.adt.widget.NEXT"
        const val ACTION_PREVIOUS = "com.music.adt.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "com.music.adt.widget.UPDATE_WIDGET"
    }
}
