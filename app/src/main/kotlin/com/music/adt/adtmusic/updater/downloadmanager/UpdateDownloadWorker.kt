package com.music.adt.adtmusic.updater.downloadmanager
...
class UpdateDownloadWorker(private val context: Context, workerParams: WorkerParameters) :
    ...
    override suspend fun doWork(): Result = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            val downloadFile = if (isZip) File(downloadDir, "adt_temp.zip") else File(downloadDir, "adt.apk")
            ...
            val finalFile = if (isZip) {
                val targetApkFile = File(downloadDir, "adt.apk")
                var extracted = false
                try {
