...
import com.music.adt.constants.IsFirstRunKey
import com.music.adt.ui.theme.adtmusicTheme
import com.music.adt.ui.utils.safeOpenUri
...
import com.music.adt.constants.LanguageCodeToName
...
class WelcomeActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.TIRAMISU) {
            ...
            com.music.adt.utils.setAppLocale(this, locale)
        }
...
val GoogleSansFlex = FontFamily(
    Font(
        resId = com.music.adt.R.font.google_sans_flex,
...
fun WelcomePagerScreen(onFinished: () -> Unit) {
    ...
    val customWelcomeFontFamily = FontFamily(
        Font(
            resId = com.music.adt.R.font.sans_flex,
            variationSettings = FontVariation.Settings(
            ...
            content = { _ ->
                Column(
                    ...
                    val welcomeText = buildAnnotatedString {
                        append(stringResource(id = com.music.adt.R.string.welcome_to_adt))
                    ...
                    val inlineContent = mapOf(
                        "inline_icon" to InlineTextContent(
                            ...
                            Icon(
                                painter = painterResource(id = com.music.adt.R.mipmap.ic_launcher_monochrome),
                    ...
                    AssistChip(
                        ...
                        label = {
                            Text(
                                text = LanguageCodeToName.getOrElse(appLanguage) { stringResource(com.music.adt.R.string.system_default) },
                                fontFamily = GoogleSansFlex
                            )
                        },
                        leadingIcon = {
                            Icon(
                                painter = painterResource(id = com.music.adt.R.drawable.language),
                                contentDescription = null,
        ...
        OnboardingPageInfo(
            content = { _ ->
                Column(
                    ...
                    Text(
                        text = stringResource(com.music.adt.R.string.perm_required),
                        style = thinHeaderStyle,
                        color = MaterialTheme.colorScheme.onBackground
                    )
                    Text(
                        text = stringResource(com.music.adt.R.string.perm_permissions),
                        fontFamily = GoogleSansFlex,
                    ...
                    Text(
                        text = stringResource(com.music.adt.R.string.perm_intro_text),
                    ...
                    Column(
                        ...
                        PermissionCard(
                            ...
                            title = stringResource(com.music.adt.R.string.perm_notif_title),
                            description = stringResource(com.music.adt.R.string.perm_notif_desc),
                        ...
                        if (BuildConfig.FLAVOR.contains("gms", ignoreCase = true)) {
                            ...
                            PermissionCard(
                                ...
                                title = stringResource(com.music.adt.R.string.perm_install_title),
                                description = stringResource(com.music.adt.R.string.perm_install_desc),
                ...
                Column(
                    ...
                    Column(
                        ...
                        PermissionCard(
                            ...
                            onClick = {
                                uriHandler.safeOpenUri(context, "https://github.com/vivizzz007/adt-music")
                            }
                        )
                        ...
                        PermissionCard(
                            icon = painterResource(com.music.adt.R.drawable.telegram),
                            ...
                            onClick = {
                                uriHandler.safeOpenUri(context, "https://t.me/adtmusicapp")
                            }
                        )
                        ...
                        PermissionCard(
                            icon = painterResource(com.music.adt.R.drawable.currency_rupee_upi),
                        ...
                        PermissionCard(
                            icon = painterResource(com.music.adt.R.drawable.buymeacoffee),
                            iconColor = Color(0xFFffb4ab),
                            iconTint = Color(0xFF690005),
            ...
            content = { onUpdateScroll ->
                Column(
                    ...
                    Column(modifier = Modifier.padding(bottom = 16.dp)) {
                        Text(
                            text = stringResource(com.music.adt.R.string.feat_discover),
                            style = thinHeaderStyle,
                            color = MaterialTheme.colorScheme.onBackground
                        )
                        Text(
                            text = stringResource(com.music.adt.R.string.feat_features),
                            fontFamily = GoogleSansFlex,
                            fontWeight = FontWeight.Bold,
                            fontSize = 48.sp,
                            color = MaterialTheme.colorScheme.primary,
                        ...
                        Text(
                            text = stringResource(com.music.adt.R.string.feat_intro),
                            style = MaterialTheme.typography.bodyLarge.copy(
                                fontFamily = GoogleSansFlex
                            ),
                            color = MaterialTheme.colorScheme.onSurfaceVariant
                    ...
                    Box(modifier = Modifier.weight(1f)) {
                        ...
                        Column(
                            ...
                            FeatureCard(
                                ...
                                iconColor = Color(0xFFffaee4),
                                iconTint = Color(0xFF8d0053),
                                title = stringResource(com.music.adt.R.string.feat_lyrics_title),
                                description = stringResource(com.music.adt.R.string.feat_lyrics_desc),
                                shape = topCardShape
                            )
                            ...
                            FeatureCard(
                                ...
                                shape = middleCardShape,
                                title = stringResource(com.music.adt.R.string.feat_download_title),
                                description = stringResource(com.music.adt.R.string.feat_download_desc)
                            )
                            ...
                            FeatureCard(
                                ...
                                iconColor = Color(0xFFffb683),
                                iconTint = Color(0xFF753403),
                                title = stringResource(com.music.adt.R.string.feat_quality_title),
                                description = stringResource(com.music.adt.R.string.feat_quality_desc),
                                shape = middleCardShape
                            )
                            ...
                            if (BuildConfig.FLAVOR.contains("gms", ignoreCase = true)) {
                                ...
                                FeatureCard(
                                    ...
                                    iconColor = Color(0xFF67d4ff),
                                    iconTint = Color(0xFF004e5d),
                                    title = stringResource(com.music.adt.R.string.feat_update_title),
                                    description = stringResource(com.music.adt.R.string.feat_update_desc),
                                    shape = middleCardShape
                                )
                            }
                            ...
                            FeatureCard(
                                ...
                                title = stringResource(com.music.adt.R.string.feat_license_title),
                                description = stringResource(com.music.adt.R.string.feat_license_desc),
                                shape = middleCardShape
                            )
                            ...
                            FeatureCard(
                                ...
                                title = stringResource(com.music.adt.R.string.feat_github_title),
                                description = stringResource(com.music.adt.R.string.feat_github_desc),
                                shape = bottomCardShape
                            )
            ...
            onSelect = { selectedLang ->
                scope.launch {
                    ...
                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.TIRAMISU) {
                        ...
                        com.music.adt.utils.setAppLocale(context, locale)
                        (context as? Activity)?.recreate()
                    }
                }
                showAppLanguageDialog = false
            },
            title = stringResource(com.music.adt.R.string.app_language),
            current = appLanguage,
            values = (listOf(SYSTEM_DEFAULT) + LanguageCodeToName.keys.toList()),
            valueText = {
                LanguageCodeToName.getOrElse(it) { stringResource(com.music.adt.R.string.system_default) }
            }
        )
    }
            ...
            Row(
                ...
                Box(
                    ...
                    WelcomeExpressiveButton(
                        text = stringResource(com.music.adt.R.string.back_button_desc),
                        onClick = {
                            if (!isFirstPage) {
                                scope.launch {
                                    pagerState.animateScrollToPage(
                ...
                Box(
                    ...
                    WelcomeExpressiveButton(
                        text = if (isLastPage) stringResource(com.music.adt.R.string.get_started) else stringResource(
                            com.music.adt.R.string.next
                        ),
                        onClick = {
                            if (isLastPage) {
...
fun RotatingShapeContainer(modifier: Modifier = Modifier) {
    ...
    Box(
        ...
        Icon(
            painter = painterResource(id = com.music.adt.R.drawable.ic_ten_sided_cookie),
            contentDescription = null,
            tint = primaryColor,
            modifier = Modifier
                .fillMaxSize()
        ...
        Icon(
            painter = painterResource(com.music.adt.R.mipmap.ic_launcher_monochrome),
            contentDescription = null,
