package com.music.adt.adtmusiccanvas
...
@Serializable
data class ADTMusicCanvasManifest(
    val items: List<ADTMusicCanvasItem> = emptyList()
)

@Serializable
data class ADTMusicCanvasItem(
    val song: String,
    val artist: String,
    val url: String,
    val album: String = "",
...
object ADTMusicCanvasProvider {
    private const val BASE_URL = "https://adtmusicanvas.mkmdevilmi.workers.dev/canvas.json" //new link
    ...
    private data class CacheEntry(
        val value: ADTMusicCanvasManifest?,
    ...
    private suspend fun fetchManifest(): ADTMusicCanvasManifest? {
        ...
        return try {
            val manifest: ADTMusicCanvasManifest = client.get(BASE_URL).body()
